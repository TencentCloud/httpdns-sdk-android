...
// NOTE: BEGIN HTTPDNS-changed
    ...
    private static class NoPreloadHolder {
         ...
         */
        private static final LayeredSocketFactory4Dns DEFAULT_FACTORY = new LayeredSocketFactory4Dns();
    }
     ...
     */
    public static LayeredSocketFactory4Dns getSocketFactory() {
    ...
    public LayeredSocketFactory4Dns(
            String algorithm,
    ...
    public LayeredSocketFactory4Dns(final KeyStore keystore, final String keystorePassword)
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public LayeredSocketFactory4Dns(final KeyStore truststore)
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
     ...
     * @hide
     */
    public LayeredSocketFactory4Dns(javax.net.ssl.SSLSocketFactory socketfactory) {
        super();
     ...
     */
    private LayeredSocketFactory4Dns() {
        super();
        this.sslcontext = null;
